...
facerec = dlib.face_recognition_model_v1("/home/pi/face/model/dlib_face_recognition_resnet_model_v1.dat")
...
# 处理存放所有人脸特征的 CSV
path_features_known_csv = "/home/pi/data/features_all.csv"
...
def reco_face(facerec, features_known_arr, detector, predictor):
    # 创建 cv2 摄像头对象
    ...
    while cap.isOpened():
        ...
        pos_namelist = []
        name_namelist = []
        #file = open('/home/pi/personlist.txt',encoding="utf-8")
        namestr = 'chenqiao,linweihong,huangwenqi,shenixangyu,guoqiaoyan,SuHongchen'
        ab=namestr.split(",")
        # 检测到人脸
        if len(faces) != 0:
...
reco_face(facerec, features_known_arr, detector, predictor)
